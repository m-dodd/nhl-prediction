...
seasons = read_csv("../data/seasons_summary.csv")
seasons <- seasons %>%
...
statistics_linear <- read_csv("../data/603-VariableTable.csv")
statistics_logistic <- read_csv("../data/603 - VariablesLog.csv")
```

```{r Load NHL Table Data, include = FALSE}
#idnhl = "1mZB6_yjISI1i1lesaXe05jFdRj2P_lF4"
#nhl.data <- read_csv(sprintf("https://docs.google.com/uc?id=%s&export=download", idnhl))
#id5 <- "1keYn2Ipg0wrw9ju7c16M3QRpxMrlnKxd"
#nhl.data.2018 <- read_csv(sprintf("https://docs.google.com/uc?id=%s&export=download", id5))
nhl.data      <- read_csv('../data/Tradition_stat_mrd10.csv')
nhl.data.2018 <- read_csv('../data/Tradition_stat_2018_mrd10.csv')
```
